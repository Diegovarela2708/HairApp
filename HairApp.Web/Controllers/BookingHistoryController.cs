...
namespace HairApp.Web.Controllers
{
    public class BookingHistoryController: Controller
    {
        ...
        public BookingHistoryController(DataContext context, IUserHelper userHelper, ICombosHelper combosHelper, IBlobHelper blobHelper, IMailHelper mailHelper,
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (user.UserType == 0)
            {
                return View(await _context.BookingHistories
                .Include(s => s.Service)
